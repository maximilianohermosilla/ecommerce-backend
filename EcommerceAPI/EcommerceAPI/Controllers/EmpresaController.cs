    ...
    public class EmpresaController : ControllerBase
    {
        ...
        public async Task<IActionResult> Insert(EmpresaRequest request)
        {
            try
            {
                ...
                {
                    return BadRequest(new BadRequest { message = "El nombre de la empresa no puede estar vacío" });
                }
        ...
        public async Task<IActionResult> Update(EmpresaRequest request, int id)
        {
            try
            {
                ...
                {
                    return new JsonResult(new { Message = "El nombre de la empresa no puede estar vacío" }) { StatusCode = 400 };
                }
            }
            catch (Exception ex)
            {
